...
processInstruction (EndInstruction instruction) = EndInstruction $ mapStep incrementStep instruction
...
process [] = 0
process (x:xs) =
    steps $ extractInstruction $ processInstruction $ buildInstruction $ buildInitialList x xs
